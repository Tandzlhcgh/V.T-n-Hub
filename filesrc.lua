...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>V.Tân Hub chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "V.Tân Hub", HidePremium = false, IntroText = "V.Tân Hub⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("V.Tân Hub SCRIPT")
W:AddLabel("DiscordV.Tân Hub")
local Section = W:AddSection({
    Name = "Status"
})
